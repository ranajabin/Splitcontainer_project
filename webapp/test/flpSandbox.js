		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#splitcontainersplitcontainerproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"splitcontainersplitcontainerproject-display": {
								"semanticObject": "splitcontainersplitcontainerproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=splitcontainer.splitcontainerproject",
									"url": sap.ui.require.toUrl("splitcontainer/splitcontainerproject")
								}
							}
						}
					}
